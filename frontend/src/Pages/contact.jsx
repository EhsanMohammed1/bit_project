...
const contact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white  pt-[20rem] lg:py-[120px]">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0 ">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">ehsankurd286@gmail.com</p>
                  </div>
              ...
              <div className="relative rounded-lg bg-gray-100 p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90 bg-violet-700"
                    >
                      Send Message
                    </button>
                  </div>
