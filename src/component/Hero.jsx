    ...
    <section class=" bg-violet-900  grid max-w-screen-l mx-auto lg:gap-8 px-4  sm:px-6 md:px-8 lg:px-10 lg:py-20 lg:grid-cols-12  ">
      <div class="mr-auto place-self-center lg:col-span-7 ">
        <h1 class="max-w-7xl mb-4 px-20 text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight text-white ">
          ...
          Design <br />
          For Your Devices
          <div class="relative w-full sm:w-9/12 md:w-8/12 lg:w-7/12 xl:w-8/12 pt-8 sm:pt-12 ">
            <div class="absolute flex items-center justify-center pl-3 pointer pt-4 ">
              <svg
                aria-hidden="true"
                class="w-5 h-5 self-center   text-gray-900 dark:text-gray-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <input
              type="search"
              id="default-search"
              class="block indent-5 w-full p-3 md:p-4 pl-10 text-sm md:text-base text-gray-900"
      ...
      <div class="lg:mt-0 px-20 lg:col-span-5 flex justify-center">
        <img
          ...
          alt="hero"
          class="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-none"
        />
      </div>
    </section>
