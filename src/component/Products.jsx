...
const Products = () => {
  return (
    <section
      className="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 tails-selected-element px-52 "
      contentEditable="true"
    >

      <div
        className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl cursor-pointer border border-violet-600"
      ...
      <div
        className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 border-red-700 rounded-sm sm:rounded-xl cursor-pointer border border-violet-600"
        data-rounded="rounded-xl"
        data-rounded-max="rounded-full"
      >
        <div
